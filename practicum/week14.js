...
const myInformation= ['Julia', '12', 'март', 'рыбы'];
...
//Обратите внмание, в JavaScript индексация элементов в массиве начинается с 0.
let result = countries[countries.length -1];
console.log(result);
...
let result3 = colors.forEach(el => console.log(el));
